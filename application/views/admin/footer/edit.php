  ...
  <div class="row">
    ...
    <div class="col-md-8 col-md-offset-2">
      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
        <?php echo form_open_multipart(admin_url("footer/edit/$info->id"));?>
          <div class="box-body">
            <div class="form-group">
              <label for="name">Version<b class="required">*</b></label>
              <?php echo form_input($html_input_version, set_value('version', $info->version)); ?>
            ...
            <?php echo form_dropdown('type', $options, set_value('type', $info->type), array('class' => 'form-control', 'width' => '30%')); ?>
            <div><?php echo form_error('type'); ?></div>
            </div>
            <div class="form-group">
              <label for="content">Content Left<b class="required">*</b></label>
              <textarea id="content_left" name="content_left" rows="20" cols="180" data-placeholder="This is my textarea to be replaced with CKEditor."><?php echo set_value('content_left', $info->content_left) ?></textarea>
              <div><?php echo form_error('content_left'); ?></div>
            </div>
            <div class="form-group">
              <label for="content">Content Right<b class="required">*</b></label>
              <textarea id="content_right" name="content_right" rows="20" cols="180" data-placeholder="This is my textarea to be replaced with CKEditor."><?php echo set_value('content_right', $info->content_right) ?></textarea>
